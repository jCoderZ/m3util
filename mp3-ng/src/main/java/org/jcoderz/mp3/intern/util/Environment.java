 ...
 * 
 * The root is initialized by looking at a system parameter M3_LIBRARY_HOME first
 * and at an environment variable next. If the variable could not be found via
 * any of those mechanisms, an IllegalArgumentException gets thrown.
 * 
 * @author mrumpf
 * 
 */
