...
public class DumpSha1Checker
{
     ...
     * <li>Directory of mp3s to be checked for dupes. Files here might be deleted!
     * <li>If a 3rd argument is passed to the class the {@link DumpSha1Checker} runns in a dry run mode.
     * </ol>
     *  
    ...
    public static void main (String[] args)
    {
        ...
        DumpSha1Checker c 
            = new DumpSha1Checker(new File(args[0]), new File(args[1]), args.length > 2);
        c.start();
    }
