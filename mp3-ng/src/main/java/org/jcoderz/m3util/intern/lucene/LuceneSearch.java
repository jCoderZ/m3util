...
public class LuceneSearch {
	 ...
	 * next page if interested in the next hits. When the query is executed for
	 * the first time, then only enough results are collected to fill 5 result
	 * pages. If the user wants to page beyond this limit, then the query is
