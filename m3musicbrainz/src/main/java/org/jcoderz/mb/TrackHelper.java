...
/**
 * Helper class to allow access to effective track data. This might be either
 * stored with the recording, or in a individually for the track.
 *
 * <p>There might be different titles in the track of the album vs in the
 * recording. Eg:
 * http://musicbrainz.org/release/58da2396-81a6-4e85-bab9-e623d42840bd
 * http://musicbrainz.org/recording/0ca12a54-b5b1-4029-b4eb-4824eb210845 <i>Will
 * You Still Love Me Tomorrow</i> -> <i>Will You Love Me Tomorrow</i>.</p>
 *
...
public final class TrackHelper
{
    ...
    public static ArtistCredit getArtistCredit(Release rel, Track track)
    {
        ArtistCredit trackArtistCredit = TrackHelper.getArtistCredit(track);
        if (trackArtistCredit == null)
        {
            trackArtistCredit = rel.getArtistCredit();
        }
        return trackArtistCredit;
    }
}
