 ...
 * structure by trusting all available tag information. If a MB release id is
 * set this one will also be added to the output directory name.
 *
 * TODO: Check IO, use logger. TODO: Bind to main interface.
 *
 * @author Andreas Mandel
 */
public class PlainRename {

    private static final String CLASSNAME = PlainRename.class.getName();
