 ...
 * metadata.
 *
 * TODO: New Musicbrainz handling of feat. etc. eg: renamed: 08 - Linda Perry -
 * Knock Me Out (feat. Grace Slick).mp3 -> 08 - Linda Perry feat. Grace Slick -
 * Knock Me Out (feat. Grace Slick).mp3.mp3
 *
 * @ f:\mp3\[Soundtrack]\The Crow~ City of Angels renamed: 16 - Heather Nova -
 * Believe in Angels (feat. Graeme Revel).mp3 -> 16 - Heather Nova feat. Graeme
 * Revell - Believe in Angels.mp3.mp3
 * @ f:\mp3\[Soundtrack]\The Crow~ City of Angels renamed: 08 - Evenstar (feat.
 * Isabel Bayrakdarian).mp3 -> 08 - Evenstar.mp3.mp3
 * @ f:\mp3\[Soundtrack]\The Lord of the Rings~ The Two Towers renamed: 01 -
 * Stefan Raab - Space Taxi (feat. Spucky, Kork & Schrotty) (Radio Version).mp3
 * -> 01 - Stefan Raab feat. Spucky, Kork & Schrotty - Space Taxi (Radio
 * Version).mp3.mp3
 * @ f:\mp3\[Soundtrack]\(T)Raumschiff Surprise Periode 1~ Die Songs
 *
...
public final class FileLocation {
    ...
    public FileLocation(Release rel, Recording recording) {
        ...
        if (rel.getMediumList().getMedium().get(0).getTrackList().getDefTrack().size() == 1) {
            ...
            final Track track = rel.getMediumList().getMedium().get(0).getTrackList().getDefTrack().get(0);
